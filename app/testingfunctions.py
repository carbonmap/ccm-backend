...
if __name__ == "__main__":
    ...
    entity_id = (
        "uk.ac.cam.kings"
    )  ## but for non-primary entities the entity_id is that of the primary and the id is that of the individual
    ...
    answer = sqliteExecute(
        "db.sqlite", "SELECT name FROM reporting_entity WHERE id=?", (id,)
    )
